...
public class Product extends BaseEntity {
	...
	@Column(name = "PRODUCT_UUID", updatable = false,
			nullable = false, columnDefinition = "VARCHAR(36)")
	...
	public void addStockHistory(Long quantity, StockType type) {
		this.stockHistories.add(ProductStockHistory.builder()
			.product(this)
			.quantity(quantity)
			.stockType(type)
			.build());
	...
	@Builder
	private Product(String companyId, String productHubId, String productName,

package org.mosaic.auth.company.presentations;
...
import org.mosaic.auth.company.application.service.CompanyService;
...
public class CompanyController {
    ...
    public ResponseEntity<CompanyPageResponse> findPageByQuerydsl(
        ...
        return ResponseEntity.ok(companyService.findAllByQueryDslPaging(predicate, pageable));
    }
